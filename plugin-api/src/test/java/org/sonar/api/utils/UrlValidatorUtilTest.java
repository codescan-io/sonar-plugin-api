...
public class UrlValidatorUtilTest {
    ...
    public void testIsUrlSafeUtil() {
        ...
        testUrls.put("https://salil.com/api/data", Boolean.TRUE);
        testUrls.put("http://trust-domain.com/path?query=v", Boolean.TRUE);
        testUrls.put("http://internal-service.example.com", Boolean.TRUE);
        ...
        testUrls.put("http://example.com@internal-server/path", Boolean.FALSE);
        ...
        for (String url : testUrls.keySet()) {
            ...
            assertThat(valid)
                    .withFailMessage(url + " url failed test")
                    .isEqualTo(expected);
        }
    }
    ...
    public void testIsTextWithUrlSafeUtil() {
        ...
        texts.put("This is a description. This shouldn't affect the output. https://salil.com/api/data", Boolean.TRUE);            	// Localhost (blocked)
        ...
        for (String text : texts.keySet()) {
            ...
            assertThat(valid)
                    .withFailMessage(text + " failed test")
                    .isEqualTo(expected);
        }
    }
    ...
    public void testSanitizerUtil() {
        ...
        texts.put("https://example.com/path?foo=bar", "https://example.com/path?foo=bar");
        texts.put("  javascript:alert('XSS')  ", null);
        texts.put("http://evil.com/%3Cscript%3Ealert(1)%3C/script%3E", "http://evil.com/");
        ...
        texts.put("ftp://example.com/resource", null);
        texts.put(null, null);
